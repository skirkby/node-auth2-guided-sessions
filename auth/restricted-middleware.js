...
module.exports = (req, res, next) => {
  ...
  // a session record to be saved is modifying req.session. Kinda hard to do
  // that if it doesn't exist (actually, you could create your own, if it didn't
  // exist, but hookups that allow express-session to know it was modified, and
  // some critical data that express-session needs to know about the session and
  // the cookie could be left off - such as the expiration date. This is
  // express-session's way of ensuring that all of this stuff is there when it
  // saves the session.)
  // 
